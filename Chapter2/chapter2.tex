...
\daisuke{特に実際のソフトウェア開発では，実装済みであるApplication Programming Interfaces~(API)を活用することが重要である．}{add citation}
...
\daisuke{}{ユーザの行動やコードを用いたAPIのsuggestについて書く．Example Guru もここ．}



\daisuke{}{発生したエラーから，APIを提案する研究について書く．}
